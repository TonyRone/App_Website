...
const Eula = () => {
  ...
  return (
    <div class="container mx-auto">
      <h1 class="title">End-User License Agreement ("Agreement")</h1>
      <p>Last updated: May 17, 2023</p>
      <p>Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using Vodeus.</p>
      <h1 class="title">Interpretation and Definitions</h1>
      <h2 class="sub-title">Interpretation</h2>
      <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
      <h2 class="sub-title">Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p><strong>Application</strong> means the software program provided by the Company downloaded by You to a Device, named Vodeus</p>
        </li>
        <li>
          <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Vodeus.</p>
        </li>
        <li>
      ...
      <h2 class="sub-title">Scope of License</h2>
      ...
      <h2 class="sub-title">User-generated contributions</h2>
      ...
      <p>Contributions to use the name or likeness or each and every such identifiable individual person to enable inclusion and use of your Contributions in any manner contemplated by the Licensed Application and this License Agreement.</p>
      ...
      <h1 class="title">Third-Party Services</h1>
      ...
      <h1 class="title">Term and Termination</h1>
      ...
      <h1 class="title">No Warranties</h1>
      ...
      <h2 class="sub-title">Severability</h2>
      ...
      <h1 class="title">Product Claims</h1>
      ...
      <h1 class="title">Changes to this Agreement</h1>
